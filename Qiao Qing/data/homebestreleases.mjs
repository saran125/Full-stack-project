...
export class ModelBestReleases extends Model {
	...
	**/
	static initialize(database) {
		ModelBestReleases.init({
            ...
            "release_image1" : { type: DataTypes.STRING(650), allowNull: false },
            "release_name1" : { type: DataTypes.STRING(650), allowNull: false },
            "release_image2" : { type: DataTypes.STRING(650), allowNull: false },
            "release_name2" : { type: DataTypes.STRING(650), allowNull: false },
            "release_image3" : { type: DataTypes.STRING(650), allowNull: false },
            "release_name3" : { type: DataTypes.STRING(650), allowNull: false },
            "release_image4" : { type: DataTypes.STRING(650), allowNull: false },
            "release_name4" : { type: DataTypes.STRING(650), allowNull: false }
		}, {
			"sequelize": database,
	...
	**/
	...
	get release_image1() { return this.getDataValue("release_image1"); }
	get release_image2() { return this.getDataValue("release_image2"); }  
	get release_image3() { return this.getDataValue("release_image3"); }  
	get release_image4() { return this.getDataValue("release_image4"); }  
