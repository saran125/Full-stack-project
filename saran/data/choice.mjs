...
export class Modelbooked extends Model {
	...
	**/
	static initialize(database) {
		Modelbooked.init({
			...
			"email"      : { type: DataTypes.STRING(128), allowNull: true, defaultValue: 'root@gmail.com'},
			"role"       : { type: DataTypes.ENUM(UserRole.User, UserRole.Admin), defaultValue: UserRole.User, allowNull: true },
	...
	**/
	...
	get roomtypes() { return this.getDataValue("roomtypes"); }	  
}
